...
${OBJECTDIR}/Arguments.o: Arguments.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/Arguments.o Arguments.cpp
...
${OBJECTDIR}/filter/sorters/NullSorter.o: filter/sorters/NullSorter.cpp 
	${MKDIR} -p ${OBJECTDIR}/filter/sorters
	${RM} $@.d
	$(COMPILE.cc) -g -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/filter/sorters/NullSorter.o filter/sorters/NullSorter.cpp
...
${OBJECTDIR}/Arguments_nomain.o: ${OBJECTDIR}/Arguments.o Arguments.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Arguments_nomain.o Arguments.cpp;\
	else  \
...
${OBJECTDIR}/filter/sorters/NullSorter_nomain.o: ${OBJECTDIR}/filter/sorters/NullSorter.o filter/sorters/NullSorter.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -I. -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/filter/sorters/NullSorter_nomain.o filter/sorters/NullSorter.cpp;\
	else  \
